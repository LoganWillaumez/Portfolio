...
const itelgata = [
  {
    ...
    cols: 2,
    featured: true,
    icon: ['/imgs/react-2.svg', '/imgs/tailwind-css-2.svg', '/imgs/vitejs.svg'],
  },
  // {
  ...
  // },
  {
    ...
    title: 'Circles',
    desc: "The group projet we did during my cursus into O'clock school. The goal is to continue the project after our cursur.",
    icon: ['/imgs/react-2.svg', '/imgs/tailwind-css-2.svg', '/imgs/redux.svg'],
  },
];
